...
\begin{ressection}{Achievements and Activities}
    \resitem{Promtpted by a grueling on call schedule that burned out numerous Systems Engineers at WordPress Engine, I started the Systems Operations Center (SOC) team to provided 3rd shift Systems Operations and Engineering coverage.}
